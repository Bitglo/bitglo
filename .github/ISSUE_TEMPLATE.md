...
This issue tracker is only for technical issues related to Bitglo Core.
General Bitglo questions and/or support requests and are best directed to the [Bitglo Discord](http://discord.bitglo.network).
...
### What version of Bitglo Core are you using?
