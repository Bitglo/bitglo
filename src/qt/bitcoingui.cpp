    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Bitglo Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Bitglo address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bitglo: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Bitglo Core"), this);
    aboutAction->setStatusTip(tr("Show information about Bitglo Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Bitglo Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Bitglo addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Bitglo addresses"));
    ...
    openAction->setStatusTip(tr("Open a bitglo: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Bitglo Core help message to get a list with possible Bitglo Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Bitglo Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Bitglo network", "", count));
    } else {
...
{
    QString strTitle = tr("Bitglo Core"); // default title
