    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Bitglo Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Bitglo Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  bitglo-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Bitglo in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 BGL, 0.1 BGL, 1 BGL and 10 BGL -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://bitglocoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://bitglocoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Bitglo Core is shutting down...") + "<br /><br />" +
