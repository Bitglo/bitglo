    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("BGL-light"), QVariant("light"));
    ui->theme->addItem(QString("BGL-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("BGL-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("BGL-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("BGL-traditional"), QVariant("trad"));
