...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "BitgloNetwork") type = BitgloNetwork;
    if(strType == "BitgloNetworkVariable") type = BitgloNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == BitgloNetwork) s = "BitgloNetwork";
    if(type == BitgloNetworkVariable) s = "BitgloNetworkVariable";
