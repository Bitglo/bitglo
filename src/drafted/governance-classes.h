 ...
 *
 *   // network
 *   CBitgloNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.bitglo.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CBitgloNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: BitgloNetwork
// //   -- signature requirements : Key1(User)
// class CBitgloNetworkVariable : public CGovernanceObject
// {
// private:
