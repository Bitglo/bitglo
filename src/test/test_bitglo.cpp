...
#define BOOST_TEST_MODULE Bitglo Test Suite

#include "test_bitglo.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_bitglo_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
