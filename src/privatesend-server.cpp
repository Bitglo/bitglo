...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Bitglo related functionality
...
/*
    ...
    allow endless transaction that would bloat Bitglo and make it unusable. To
