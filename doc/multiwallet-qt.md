...
Only requiring some minor changes is bitglo.cpp.
...
Changes to bitglo.cpp
----------------------
bitglo.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
