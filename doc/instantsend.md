...
This mechanism has been integrated into Bitcore-Node-Bitglo which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/bitglocoin/insight-api-bitglo#web-socket-api](https://github.com/bitglocoin/insight-api-bitglo#web-socket-api)
* API: [https://github.com/bitglocoin/insight-api-bitglo#instantsend-transactions](https://github.com/bitglocoin/insight-api-bitglo#instantsend-transactions)
...
By default, the Bitglo Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Bitglo Core daemon:
